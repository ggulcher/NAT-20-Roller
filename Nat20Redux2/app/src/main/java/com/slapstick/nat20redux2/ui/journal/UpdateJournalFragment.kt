...
import kotlinx.android.synthetic.main.fragment_journal_update.*
import kotlinx.android.synthetic.main.fragment_journal_update.view.*
...
class UpdateJournalFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_journal_update, container, false)
    ...
    private fun updateJournal() {
        ...
        if(inputCheck(journalTitle, journalContent)) {
            val updatedJournal = Journal(args.currentJournal.id, journalTitle, journalContent)
